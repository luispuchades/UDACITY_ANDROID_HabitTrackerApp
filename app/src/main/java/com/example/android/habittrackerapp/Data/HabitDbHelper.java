...
public class HabitDbHelper extends SQLiteOpenHelper {
    ...
    /** LOG_TAG constant created for log tracking in the Android Monitor  */
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_HABIT_TABLE = "CREATE TABLE " + HabitEntry.TABLE_NAME + " ("
                ...
                + HabitEntry.COLUMN_HABIT_KIND + " TEXT NOT NULL DEFAULT 0, "
                + HabitEntry.COLUMN_HABIT_ACTIVITY + " INTEGER NOT NULL DEFAULT 0);";
